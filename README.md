...
C, STM32 HAL, STM32CubeIDE/CubeMX, NUCLEO-F411RE (STM32F411RET6, ARM Cortex-M4), SSD1306 OLED, PuTTY, ST-LINK/GDB.
...
- Extend the SPI/I2C bus work into an actual sensor driver (e.g. an IMU or distance sensor) as the first real ADAS input
- Move the alert logic into a proper task/interrupt structure instead of a single polling loop
- Add a CAN interface to match how alerts would actually reach a vehicle bus
